...
function devuelveMilisegundosCadena(cadena){
	return parseInt(cadena)*1000;
	/*Devuelve un valor convertido a número y pasado a milisegundos*/
}
function pasoBinario(x){
    return x.toString(2);
}